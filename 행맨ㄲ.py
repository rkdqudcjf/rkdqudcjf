...
while not exit:
    ...
    I_arm = round(l_arm*1.5)
    M=(L[0]-I_arm*math.cos(30*math.pi/180),
         L[1]+I_arm*math.sin(30*math.pi/180))
    N=(L[0]+I_arm*math.cos(30*math.pi/180), 
        L[1]+I_arm*math.sin(30*math.pi/180))
    M = tup_r(M)
    N = tup_r(N)
    ...
    entry_bg_size=80
    pygame.draw.rect(screen, white, tup_r((size[0]/2-entry_bg_size/2, size[1]*17.5/18-
                     entry_bg_size/2, entry_bg_size, entry_bg_size)))
